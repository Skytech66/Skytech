...
<div class="wrapper d-flex align-items-stretch">
	...
	<div class="footer">
		<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This sytem is powered <i class="icon-heart" aria-hidden="true"></i> by <a href="https://meg.co.ke" target="_blank">Sky technologies</a>

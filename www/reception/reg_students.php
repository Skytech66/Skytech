...
<div class="row mb-2">
	...
	<div class="col-sm">
		<div class="form-group">
			<label for="recipient-name" class="col-sm-form-label">Select Department:</label>
			<select class="form-select form-select-sm" aria-label=".form-select-md example" id="dorm" name="dorm" required>
			  <option selected value="Creche">Select </option>
			  <option selected value="Mt Kenya">lower primary</option>
			  <option selected value="Mt Elgon">Upper primary</option>
			  <option selected value="Mt Longonot">JHS</option>
			</select>
		</div>
	</div>
</div>
	...
	<div class="col-sm">
		...
		<div class="form-group">
			<select class="form-select form-select-sm" aria-label=".form-select-md example" id="religion" name="religion" required>
			  ...
			  <option selected value="Hindu">Others</option>
			</select>
		</div>
	</div>
	<div class="col-sm">
...
<div class="row mb-2">
	...
	<div class="col-sm">
		<label for="recipient-name" class="col-sm-form-label">Address:</label>
		<div class="form-group">
...
<div class="row mb-2">
	...
	<div class="col-sm">
		<label for="recipient-name" class="col-sm-form-label">Location:</label>
...
<div class="row mb-2">
	...
	<div class="col-sm">
		<label for="recipient-name" class="col-sm-form-label">Emergency contact:</label>

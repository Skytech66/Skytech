...
class mypdf extends FPDF {
    ...
    // Removed the getSignatureImage function entirely because signature images are removed.
    ...
    foreach ($totalScores as $admno => $data) {
        ...
        foreach ($subjects as $row) {
            ...
            if (is_numeric($originalPosition) && $originalPosition > 0) {
                // Use ordinal function to display position with correct suffix
        ...
        // Removed signature images section as requested
